...
namespace Microsoft.Exchange.Data.Globalization
{
    ...
    internal class Charset
    {
        ...
        public Culture Culture { get { return this.culture; } }
        ...
        public bool IsDetectable
        {
            ...
            get { return this.mapIndex >= 0 && 0 != (CodePageMapData.codePages[this.mapIndex].flags & CodePageFlags.Detectable); }
        }

        
        public bool IsAvailable { get { return !this.available ? false : this.encoding != null ? true : this.CheckAvailable(); } }

        
        
        
        
        public bool IsWindowsCharset { get { return this.windows; } }
        ...
        public static Charset DefaultMimeCharset { get { return Culture.Default.MimeCharset; } }

        
        
        
        public static Charset DefaultWebCharset { get { return Culture.Default.WebCharset; } }

        
        
        
        public static Charset DefaultWindowsCharset { get { return Culture.Default.WindowsCharset; } }

        
        
        
        public static Charset ASCII { get { return CultureCharsetDatabase.data.asciiCharset; } }

        
        
        
        public static Charset UTF8 { get { return CultureCharsetDatabase.data.utf8Charset; } }

        
        
        
        public static Charset Unicode { get { return CultureCharsetDatabase.data.unicodeCharset; } }
        ...
        internal int MapIndex { get { return this.mapIndex; } }

        internal CodePageKind Kind
        {
            get { return this.mapIndex < 0 ? CodePageKind.Unknown : CodePageMapData.codePages[this.mapIndex].kind; }
        }

        internal CodePageAsciiSupport AsciiSupport
        {
            get { return this.mapIndex < 0 ? CodePageAsciiSupport.Unknown : CodePageMapData.codePages[this.mapIndex].asciiSupport; }
        }

        internal CodePageUnicodeCoverage UnicodeCoverage
        {
            get { return this.mapIndex < 0 ? CodePageUnicodeCoverage.Unknown : CodePageMapData.codePages[this.mapIndex].unicodeCoverage; }
        }

        internal bool IsSevenBit
        {
            
            get { return this.mapIndex >= 0 && 0 != (CodePageMapData.codePages[this.mapIndex].flags & CodePageFlags.SevenBit); }
        }
            ...
            get
            {
                return this.mapIndex < 0 ?
                    ...
                    0 != (CodePageMapData.codePages[this.mapIndex].flags & CodePageFlags.Detectable) ?
                        this.codePage :
                        CodePageMapData.codePages[this.mapIndex].detectCpid;
            }
        }
            ...
            if (this.encoding == null && this.available)
            {
                try
                {
                    if (this.codePage == 20127)
                    {
                        ...
                        this.encoding = System.Text.Encoding.GetEncoding(this.codePage, new AsciiEncoderFallback(), System.Text.DecoderFallback.ReplacementFallback);
                    }
                    ...
                    {
                        this.encoding = System.Text.Encoding.GetEncoding(this.codePage);
                    }
                }
    ...
    internal class Culture
    {
        ...
        public int LCID { get { return this.lcid; } }
        ...
        public Charset WindowsCharset { get { return this.windowsCharset; } }

        
        
        
        
        public Charset MimeCharset { get { return this.mimeCharset; } }

        
        
        
        
        public Charset WebCharset { get { return this.webCharset; } }
        ...
        public string NativeDescription { get { return this.nativeDescription; } }

        
        
        
        public Culture ParentCulture { get { return this.parentCulture; } }

        
        
        
        internal int[] CodepageDetectionPriorityOrder { get { return this.GetCodepageDetectionPriorityOrder(CultureCharsetDatabase.data); } }

        
        
        
        public static Culture Default { get { return CultureCharsetDatabase.data.defaultCulture; } }

        
        
        
        public static Culture Invariant { get { return CultureCharsetDatabase.data.invariantCulture; } }
            ...
            if (this.codepageDetectionPriorityOrder == null)
            {
                this.codepageDetectionPriorityOrder =
                    CultureCharsetDatabase.GetCultureSpecificCodepageDetectionPriorityOrder(
                            this,
                            this.parentCulture == null || this.parentCulture == this ?
                                data.defaultDetectionPriorityOrder :
                                this.parentCulture.GetCodepageDetectionPriorityOrder(data));
            }
        ...
        internal System.Globalization.CultureInfo GetSpecificCultureInfo()
        {
            ...
            try
            {
                return System.Globalization.CultureInfo.CreateSpecificCulture(this.cultureInfo.Name);
            }
            catch (ArgumentException)
            {
                return System.Globalization.CultureInfo.InvariantCulture;
    ...
    internal static class CultureCharsetDatabase
    {
        ...
        private struct WindowsCodePage
        {
            ...
            public int MimeCodePage { get { return this.mimeCodePage; } }
            public int WebCodePage { get { return this.webCodePage; } }
            public string GenericCultureDescription { get { return this.genericCultureDescription; } }
        }
        ...
        private struct CultureData
        {
            ...
            public int LCID { get { return this.lcid; } }
            public string Name { get { return this.name; } }
            public int WindowsCodePage { get { return this.windowsCodePage; } }
            public int MimeCodePage { get { return this.mimeCodePage; } }
            public int WebCodePage { get { return this.webCodePage; } }
            public string ParentCultureName { get { return this.parentCultureName; } }
            public string Description { get { return this.description; } }
        }
        ...
        private static GlobalizationData LoadGlobalizationData(string defaultCultureName)
        {
            ...
            GlobalizationData newData = new GlobalizationData();
            ...
            foreach (CultureInfo ci in cultures)
            {
                ...
                InternalDebug.Assert(!newData.lcidToCulture.ContainsKey(ci.LCID), String.Format("Culture LCID {0:X} has more than one entry in CLR (\"{1}\")", ci.LCID, ci.Name));
                ...
                InternalDebug.Assert(!newData.nameToCulture.ContainsKey(ci.Name), String.Format("Culture name \"{0}\" is already reserved in CLR for another LCID ({1:X})", ci.Name, ci.LCID));
            ...
            {
                InternalDebug.Assert(!newData.codePageToCharset.ContainsKey(ei.CodePage), String.Format("CodePage {0} has more than one entry in CLR (\"{1}\")", ei.CodePage, ei.Name));
            ...
            foreach (WindowsCodePage wcp in windowsCodePages)
            {
                if (wcp.LCID == 0)
                {
            ...
            for (int i = 0; i < CodePageMapData.codePages.Length; i++)
            {
                ...
                if (charset.Culture == null)
                {
                    ...
                    Charset windowsCharset = newData.codePageToCharset[CodePageMapData.codePages[i].windowsCpid];
            ...
            foreach (CultureInfo ci in cultures)
            {
                ...
                if (culture.WindowsCharset == null)
                {
                    ...
                    else
                    {
                        ...
                        bool validWindowsCodepage = false;
            ...
            */
            ...
            IList<CtsConfigurationSetting> settings = Internal.ApplicationServices.Provider.GetConfiguration("Globalization");
            ...
            foreach (CtsConfigurationSetting setting in settings)
            {
                ...
                switch (command.ToLower())
                {
                    case "overridecharsetdefaultname":  
                            ...
                            charset.SetDefaultName(defaultNameArg);
                            break;
                    ...
                    case "addcharsetaliasname":         
                            ...
                            if (aliasNameArg.Length > newData.maxCharsetNameLength)
                            {
                    ...
                    case "overridecharsetculture":      
                            ...
                            {
                                if (!newData.lcidToCulture.TryGetValue(lcid, out culture))
                                {
                    ...
                    case "overrideculturecharset":      
                            ...
                            if (string.IsNullOrEmpty(cultureArg) ||
                                (string.IsNullOrEmpty(windowsCharsetArg) && string.IsNullOrEmpty(mimeCharsetArg) && string.IsNullOrEmpty(webCharsetArg)))
                            {
        ...
        {
            int[] newPriorityList = new int[CodePageDetectData.codePages.Length];
    ...
    internal class RemapEncoding : System.Text.Encoding
    {
        ...
        public override int CodePage { get { return this.encodingEncoding.CodePage; } }
        public override String BodyName { get { return this.encodingEncoding.BodyName; } }
        public override String EncodingName { get { return this.encodingEncoding.EncodingName; } }
        public override String HeaderName { get { return this.encodingEncoding.HeaderName; } }
        public override String WebName { get { return this.encodingEncoding.WebName; } }
        public override int WindowsCodePage { get { return this.encodingEncoding.WindowsCodePage; } }
        public override bool IsBrowserDisplay { get { return this.encodingEncoding.IsBrowserDisplay; } }
        public override bool IsBrowserSave { get { return this.encodingEncoding.IsBrowserSave; } }
        public override bool IsMailNewsDisplay { get { return this.encodingEncoding.IsMailNewsDisplay; } }
        public override bool IsMailNewsSave { get { return this.encodingEncoding.IsMailNewsSave; } }
        public override bool IsSingleByte { get { return this.encodingEncoding.IsSingleByte; } }
    ...
    internal class AsciiEncoderFallback : System.Text.EncoderFallback
    {
        ...
        {
            get { return AsciiFallbackBuffer.MaxCharCount; }
        }
